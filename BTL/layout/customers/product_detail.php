            ...
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="s_Product_carousel">
                            <img class="img-fluid" src="./webroot/admin/uploads/products/<?php echo $product['image'];?>" alt="">
                    </div>
                </div>
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h4><?php echo $model->get_NameUser_id($cmt['user_id'])['name'];?></h4>
                                            <h5><?php echo date('d/m/Y', strtotime($cmt['created'])) ?></h5>
                            ...
                            <div class="review_box">
                                ...
                                <form action="index.php?controller=product&action=comment&id=<?php echo $product['id'];?>" method="POST">
                                    ...
                                    <div class="col-md-12 text-right">
                                        <button type="submit" value="submit" name="Comment" class="btn primary-btn">Submit Now</button>
                                    </div>
                                </form>
                            </div>
                        </div>
