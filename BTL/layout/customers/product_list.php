                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product">
                                <a href="index.php?controller=product&action=product_detail&id=<?php echo $row['id'];?>">
                                <img class="img-fluid" src="webroot/admin/uploads/products/<?php echo $row['image']?>" alt="">
                                <div class="product-details">
                                    <h6><?php echo $row['name'];?></h6>
                                    <div class="price">
                                        <h6 class="l-through"><?php echo number_format($row['price']);?>VNĐ</h6>
                                    </div>
